...
public class prg_수식최대화 {
    ...
    // 3. 정해진 우선순위로 계산한다. 임시 LinkedList로 연산자, 피연산자 옮겨서 그것을 이용해서 remove하며 계산..
    // 연산자ByPriority 와 피연산자로 계산.
    List<Long> copiedNum;
    List<Character> copiedOper;
    private void calculate() {
        copiedNum= new ArrayList<>(numbers);
        copiedOper = new ArrayList<>(operations);
        long sum = 0;
